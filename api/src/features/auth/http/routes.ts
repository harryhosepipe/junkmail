...
import { sendMagicLinkEmail } from "../../../platform/auth/email.js";
import {
  clearSessionCookie,
  createSession,
  deleteSession,
  ...
  getSessionToken,
  setSessionCookie,
} from "../../../platform/auth/session.js";
import { ensureSameOrigin } from "../../../platform/auth/csrf.js";
import { generateToken, hashToken } from "../../../platform/auth/tokens.js";
import { deriveVoterHash, VOTER_COOKIE_NAME } from "../../../platform/auth/voter.js";
import { parseAliasPatch } from "../domain/contracts.js";
import { resolveInvitedUploaderByEmail } from "../../../platform/auth/userProfile.js";
import {
...
import { buildProfileSummary, updateAliasAndProfile } from "../application/profile.js";
